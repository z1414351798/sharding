...
import com.z.sharding.pojo.Versionable;
...
public class CacheService {
    ...
    private <T> T loadAndCache(RBucket<T> bucket, Supplier<T> dataLoader, String key) {
        ...
        if (!(value instanceof List)) {
            ...
            if (value instanceof Versionable vo) {
                ...
                RBucket<Long> versionBucket = redissonClient.getBucket(versionKey);
                ...
                // 更新 version
                versionBucket.set(vo.getVersion());
            }
        }
    ...
    public <T> void set(String key, T value, long timeoutSeconds) {
        redissonClient.getBucket(key).set(value, timeoutSeconds, TimeUnit.SECONDS);
    }
}
